...
window.analytics.load('Oi4IFL5eZZwjDIIcmGMLsiVAxMcsJIUV');
...
(function() {
  ...
  jQuery(function($) {
    $(document).ready(function() {
      if (!$('dl.tabs dd').hasClass('active')) {
        return setActive();
      }
    });
    return $('dl.tabs dd').on('click', setActive);
  });
  ...
  setActive = function(item) {
    ...
    if (!item) {
      ...
      return $('div.tabs-content div').first().addClass('active');
    } else {
